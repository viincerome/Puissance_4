...
public class SettingView extends JFrame implements ActionListener {
    ...
    JComboBox liste_label_ligne = new JComboBox(Ligne);
    JLabel label_ligne = new JLabel ("Nombre de ligne");
    
    private String[] colonne = {"1","2","3","4","5","6","7"};
    JComboBox liste_label_colonne = new JComboBox(colonne);
    JLabel label_colonne = new JLabel ("Nombre de colonne");
    
    private String[] joueur = {"2","3","4"};
    JComboBox liste_label_joueur = new JComboBox(joueur);
